...
namespace _02._7_interpolacao
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string documento = 
                //com o $ é possível interpolar strings, com isso {aqui podemos colocar uma variável}
...
labor diário no período compreendido entre {contrato.InicioJornada:hh:mm} e {contrato.FimJornada:t}, 
